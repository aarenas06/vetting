...
<head>
    ...
    <meta charset="utf-8">
    <link rel="icon" href="/vetting/landing/images/favicon.ico" type="image/x-icon">
    <!-- Stylesheets-->
...
<body>
    ...
    <div class="page">
                        ...
                        <div class="rd-navbar-main">
                            <div class="rd-navbar-nav-wrap" id="rd-navbar-nav-wrap">
                                ...
                                <ul class="rd-navbar-nav">
                                    ...
                                    <li class="rd-nav-item active"><a class="rd-nav-link" href="index-2.html">Registrarse</a>
                                    </li>
                                    <li class="rd-nav-item active"><a class="rd-nav-link" href="index-2.html">Inciar sesion</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6 wow-outer">
                                ...
                                <article class="box-minimal">
                                    ...
                                    <div class="box-minimal-main wow-outer">
                                        ...
                                        <p class="wow fadeInUpSmall">Our team consists of more than 20 qualified and experienced accountants, marketers, and managers.</p>
                                    </div>
                                </article>
                            </div>
                            <div class="col-sm-6 wow-outer">
                                ...
                                <article class="box-minimal">
                                    ...
                                    <div class="box-minimal-main wow-outer">
                                        ...
                                        <p class="wow fadeInUpSmall" data-wow-delay=".1s">Our acquaintance with a client always begins with a free consultation to find out possible solutions to their problems.</p>
                                    </div>
                                </article>
                            </div>
                            <div class="col-sm-6 wow-outer">
                                ...
                                <article class="box-minimal">
                                    ...
                                    <div class="box-minimal-main wow-outer">
                                        ...
                                        <p class="wow fadeInUpSmall" data-wow-delay=".2s">All results that you get from us are 100% guaranteed to bring you to a whole new level of profitability and financial success.</p>
                                    </div>
                                </article>
                            </div>
                            <div class="col-sm-6 wow-outer">
        ...
        <section class="section-lg text-center">
            ...
            <div class="wow-outer button-outer"><a class="button button-primary-outline button-winona offset-top-2 wow slideInUp" href="services.html">View all services</a></div>
        </section>
        <!-- Pricing-->
