...
include($_SERVER['DOCUMENT_ROOT'] . '/Vetting/modules/Planes/controller/controller.php');
...
<h3 class="title">Modulo de Planes</h3>
<h5>Gestiona Los planes para el comercio</h5>
<hr>
<div class="row">
    <div class="col-lg-8">
        <div class="header">
